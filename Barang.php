      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Data Barang Minimarket Mitra Jaya</a>
          </div>
		...
		while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
			?>
                        <tr>                          
                          ...
                          <td>
                            <?php echo $d['JENIS_BRG']; ?>
                          </td>
						  <td>
                            <?php echo $d['HARGA_BRG']; ?>
                          </td>
						  <td>
                            <?php echo $d['JMLH_STOK']; ?>
                          </td>
						  <td>
                            <?php echo $d['TGL_KADALUARSA']; ?>
                          </td>
						  ...
						  <a href="Barang_update.php?id=<?= $d['ID_BARANG'] ?>">
							...
							<a href="delete.php?id=<?= $d['ID_BARANG'] ?>" 
