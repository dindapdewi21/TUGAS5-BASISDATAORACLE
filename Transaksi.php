      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Data Transaksi Minimarket Mitra Jaya</a>
          </div>
		...
		while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
			?>
                        <tr>                          
						  ...
						  <td>
                            <?php echo $d['HARGA_TRANSAKSI']; ?>
                          </td>
						  <td>
                            <?php echo $d['JMLH_BRG']; ?>
                          </td>
						  <td>
                            <?php echo $d['TOTAL_PEMBAYARAN']; ?>
                          </td>
						  ...
						  <a href="Transaksi_update.php?id=<?= $d['ID_TRANSAKSI'] ?>">
							...
							<a href="delete.php?id=<?= $d['ID_TRANSAKSI'] ?>" 
